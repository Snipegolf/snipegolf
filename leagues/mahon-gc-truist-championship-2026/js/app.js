 ...
 *   mahon-gc-truist-championship-2026               league slug
...
(function () {
  ...
  var SLUG     = 'mahon-gc-truist-championship-2026';
  ...
  function loadConfig() {
    ...
    fetchJson(url, function (err, cfg) {
      ...
      if (cfg.tournament) {
        ...
        document.title = document.title.replace('Mahon GC — Truist Championship 2026', cfg.tournament);
      }
