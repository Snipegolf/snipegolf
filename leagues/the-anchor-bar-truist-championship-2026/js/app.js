 ...
 *   the-anchor-bar-truist-championship-2026               league slug
...
(function () {
  ...
  var SLUG     = 'the-anchor-bar-truist-championship-2026';
  ...
  function loadConfig() {
    ...
    fetchJson(url, function (err, cfg) {
      ...
      if (cfg.tournament) {
        ...
        document.title = document.title.replace('The Anchor Bar — Truist Championship 2026', cfg.tournament);
      }
