 ...
 *   cobh-golf-club-pga-championship-2026               league slug
 *   401811947            ESPN tournament event id
 *
...
(function () {
  ...
  var SLUG     = 'cobh-golf-club-pga-championship-2026';
  var ESPN_ID  = '401811947';
  ...
  function loadConfig() {
    ...
    fetchJson(url, function (err, cfg) {
      ...
      if (cfg.tournament) {
        ...
        document.title = document.title.replace('Cobh Golf Club — PGA Championship 2026', cfg.tournament);
      }
